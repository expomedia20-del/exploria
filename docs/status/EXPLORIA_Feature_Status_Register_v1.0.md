...
| حقوقی و Data Governance | مالک شخص حقیقی، Iran-only/Rial-only، نقش‌های مالک، سقف‌ها و Candidateهای Due-diligence پذیرفته شده‌اند؛ Legal، Operations/Security و Vendor Contract هنوز تأیید نشده‌اند | OD-002، OD-009، Approval Pack، Owner Decision Record و `EXPLORIA_Provider_Due_Diligence_2026-08-18.md` | `PILOT_BLOCKED` | Legal Approver، Operations/Security Owner، پاسخ مکتوب Vendor، متن حقوقی، دامنه رسمی، جانشین Incident و Provider دوم ایرانی |
