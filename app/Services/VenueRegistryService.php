...
class VenueRegistryService
{
    ...
    private function demoStressPlan(Venue $venue, array $locationProfile): array
    {
        ...
        $items = [
            ...
            $this->demoStressItem('redemption', 'تایید مصرف توسط فروشگاه', 'فروشگاه / واحد تجاری', $redemptions > 0 && $confirmedRedemptions > 0, 'کد پاداش باید در پنل فروشگاه تایید و موجودی از رزرو به مصرف‌شده منتقل شود.', $campaignCode ? '/partner/dashboard?campaign='.$campaignCode : '/partner/dashboard', $confirmedRedemptions.' تایید'),
