    ...
    private function executionPlans(): array
    {
        $plans = [
            ...
            'ravaq-rewarded-shopping-treasure' => [
                ...
                'connectedSurfaces' => ['پنل مدیر رواق', 'پنل فروشگاه', 'مدیریت واحدهای تجاری', 'کوپن فروشگاه', 'داشبورد کمپین'],
                'rewardBasket' => [
