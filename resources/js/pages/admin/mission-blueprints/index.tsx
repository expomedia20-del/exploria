                ...
                <section className="grid gap-4 xl:grid-cols-[0.85fr_1.15fr]">
                    <div className="rounded-lg border border-sidebar-border/70 bg-background dark:border-sidebar-border">
                        ...
                        <div className="grid gap-3 p-4">
                            {principles.map((principle) => (
                                <article key={principle.title} className="rounded-lg border border-sidebar-border/70 p-3 dark:border-sidebar-border">
                    ...
                    <div className="rounded-lg border border-sidebar-border/70 bg-background dark:border-sidebar-border">
                        ...
                        <div className="grid gap-3 p-4 md:grid-cols-5">
                            {designFlow.map((step) => (
                                <article key={step.step} className="rounded-lg border border-sidebar-border/70 p-3 dark:border-sidebar-border">
                ...
                <section className="rounded-lg border border-sidebar-border/70 bg-background dark:border-sidebar-border">
                    ...
                    <div className="grid gap-4 p-4 lg:grid-cols-2">
                        {visibleTemplates.map((template) => (
                            <article key={template.code} className="rounded-lg border border-sidebar-border/70 p-4 dark:border-sidebar-border">
                    ...
                    <div className="rounded-lg border border-sidebar-border/70 bg-background dark:border-sidebar-border">
                        ...
                        <div className="grid gap-3 p-4">
                            {rewardVault.map((reward) => (
                                <article key={reward.type} className="rounded-lg border border-sidebar-border/70 p-3 dark:border-sidebar-border">
                                    <div className="flex items-center gap-2">
