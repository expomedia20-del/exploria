...
export default function SponsorActivationIndex({
    stats,
    sponsors,
    sponsorships,
    partnerAssignments,
    ...
    const generatedSponsorCode = useMemo(() => {
        const venue = formOptions.venues.find(
            (option) => option.id === sponsorVenueId,
        );
        const venuePrefix = venue?.code ?? 'global';

        return uniqueSponsorCode(
            `${venuePrefix}-${sponsorType}`,
            sponsors.map((sponsor) => sponsor.code),
        );
            ...
            >
                    ...
                    <section className="grid gap-4 xl:grid-cols-2">
                        <div className="exploria-panel">
                            <div className="border-b border-border/70 px-4 py-3 dark:border-sidebar-border">
                                ...
                                <p className="mt-1 text-sm text-muted-foreground">
                                    برند، سازمان، واحد علمی یا فرهنگی را برای
                                    اتصال به کمپین ثبت کنید.
                                </p>
                            </div>
                            <Form
                                    ...
                                    <>
                                        <div className="grid gap-1.5">
                                            ...
                                            <input
                                                ...
                                                placeholder="مثلا برند حامی خانواده"
                                            />
                                        ...
                                        <div className="grid gap-1.5">
                                            ...
                                            >
                                                <option value="">
                                                    سراسری / بدون مکان خاص
                                                </option>
                                                {formOptions.venues.map(
                                                    (venue) => (
                                                        <option
                                                            key={venue.id}
                                                            value={venue.id}
                        ...
                        <div className="exploria-panel">
                            <div className="border-b border-border/70 px-4 py-3 dark:border-sidebar-border">
                                ...
                                <p className="mt-1 text-sm text-muted-foreground">
                                    هدف، بسته و بودجه حمایت را برای یک کمپین
                                    مشخص ثبت کنید.
                                </p>
                            </div>
                            <Form
                                action="/admin/campaign-sponsorships"
                                method="post"
                                options={{ preserveScroll: true }}
                                className="grid gap-4 p-4 md:grid-cols-2"
                            >
                                {({ processing, errors }) => (
                                    <>
                                        ...
                                        <div className="grid gap-1.5">
                                            ...
                                            <InputError
                                                message={
                                                    errors.sponsor_account_id
                                                }
                                            />
                                        </div>
                                        <div className="grid gap-1.5">
                                            <label
                                                htmlFor="sponsorship_goal"
                                                className="text-xs font-medium"
                                            >
                                                هدف حمایت
                                            </label>
                                        ...
                                        <div className="grid gap-1.5">
                                            ...
                                            <select
                                                id="package_type"
                                                name="package_type"
                                                defaultValue="pilot_activation"
                                                className="h-9 rounded-md border border-input bg-background px-3 text-sm"
                                            >
                                                <option value="pilot_activation">
                                                    فعال‌سازی پایلوت
                                                </option>
                                                <option value="display_media">
                                                    تبلیغ نمایشگر
                                                </option>
                                                <option value="treasure_sponsor">
                                                    اسپانسر گنج
                                                </option>
                                                <option value="family_team_challenge">
                                                    چالش خانوادگی/تیمی
                                                </option>
                                                <option value="scientific_cultural_challenge">
                                                    چالش علمی/فرهنگی
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div className="grid gap-1.5 md:col-span-2">
                                            <label
                                                htmlFor="sponsorship_notes"
                                                className="text-xs font-medium"
                                            >
                                                یادداشت حمایت
                                            </label>
                                            <textarea
                                                id="sponsorship_notes"
                                                name="notes"
                                                className="min-h-20 rounded-md border border-input bg-background px-3 py-2 text-sm"
                                            />
                                        </div>
                        ...
                        <div className="exploria-panel xl:col-span-2">
                            <div className="border-b border-border/70 px-4 py-3 dark:border-sidebar-border">
                                ...
                                <p className="mt-1 text-sm text-muted-foreground">
                                    مشخص کنید اسپانسر از طریق کدام فروشگاه، کافه
                                    یا واحد عضو کمپین فعال می‌شود.
                                </p>
                            </div>
                            <Form
                                action="/admin/sponsor-partner-assignments"
                                method="post"
                                options={{ preserveScroll: true }}
                            ...
                            >
                                {({ processing, errors }) => (
                                    <>
                                        <div className="grid gap-1.5">
                                            <label
                                                htmlFor="assignment_sponsor_account_id"
                                                className="text-xs font-medium"
                                            >
                                                اسپانسر
                                            </label>
                                            <select
                                                id="assignment_sponsor_account_id"
                                                name="sponsor_account_id"
                                                required
                                                className="h-9 rounded-md border border-input bg-background px-3 text-sm"
                                            >
                                        ...
                                        <div className="grid gap-1.5">
                                            <label
                                                htmlFor="assignment_partner_account_id"
                                                className="text-xs font-medium"
                                            >
                                                واحد عضو
                                            </label>
                                            <select
                                                id="assignment_partner_account_id"
                                        ...
                                        <div className="grid gap-1.5">
                                            <label
                                                htmlFor="assignment_campaign_id"
                                                className="text-xs font-medium"
                                            >
                                                کمپین
                                            </label>
                                            <select
                                                id="assignment_campaign_id"
                                                name="campaign_id"
                                                defaultValue={
                                                    selectedCampaign?.id ?? ''
                                                }
                                        ...
                                        <div className="grid gap-1.5">
                                            ...
                                            <select
                                                ...
                                                defaultValue="sales_point"
                                                className="h-9 rounded-md border border-input bg-background px-3 text-sm"
                                            >
                                                <option value="sales_point">
                                                    نقطه فروش محصول اسپانسر
                                                </option>
                                                <option value="reward_redemption">
                                                    تحویل جایزه
                                                </option>
                                                <option value="challenge_host">
                                                    میزبان چالش
                                                </option>
                                                <option value="discount_redemption">
                                                    مصرف کد تخفیف
                                                </option>
                                                <option value="product_sampling">
                                                    نمونه‌گیری محصول
                                                </option>
                                                <option value="content_delivery">
                                                    ارائه محتوا
                                                </option>
                                            </select>
                                        </div>
                ...
                <section className="grid gap-4 xl:grid-cols-[0.8fr_1.2fr]">
                    ...
                    <div className="exploria-panel">
                        <div className="border-b border-border/70 px-4 py-3 dark:border-sidebar-border">
                            <h2 className="font-semibold">
                                حمایت‌های متصل به کمپین
                            </h2>
                        </div>
                        <div className="min-w-[820px] divide-y divide-border/70">
                            {sponsorships.length === 0 ? (
                                <div className="p-6 text-sm text-muted-foreground">
                                    هنوز حمایتی به کمپین وصل نشده است.
                                </div>
                            ) : (
                                sponsorships.map((sponsorship) => (
                                    <article
                                        key={sponsorship.id}
                                        className="grid grid-cols-[1.2fr_1fr_1fr_0.8fr_0.8fr] items-center gap-3 px-4 py-3 text-sm"
                                    >
                                        <div className="min-w-0">
                                            <p className="truncate font-medium">
                ...
                <section className="exploria-panel">
                    <div className="border-b border-border/70 px-4 py-3 dark:border-sidebar-border">
                        <h2 className="font-semibold">
                            واحدهای عضو متصل به اسپانسر
                        </h2>
                    </div>
                    <div className="min-w-[920px] divide-y divide-border/70">
                        {partnerAssignments.length === 0 ? (
                            <div className="p-6 text-sm text-muted-foreground">
                                هنوز واحد عضوی به اسپانسر وصل نشده است.
                            </div>
                        ) : (
                            partnerAssignments.map((assignment) => (
                                <article
                                    key={assignment.id}
                                    className="grid grid-cols-[1fr_1fr_1fr_0.9fr_0.7fr] items-center gap-3 px-4 py-3 text-sm"
                                >
                                    <div className="min-w-0">
                                        <p className="truncate font-medium">
                ...
                <section className="exploria-panel">
                    <div className="border-b border-border/70 px-4 py-3 dark:border-sidebar-border">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="font-semibold">
                                پیشنهادهای ارسال‌شده توسط اسپانسر
                            </h2>
                        </div>
                    </div>
                    <div className="min-w-[1040px] divide-y divide-border/70">
                        {proposals.length === 0 ? (
                            <div className="p-6 text-sm text-muted-foreground">
                                هنوز پیشنهادی از سمت اسپانسر ثبت نشده است.
                            </div>
                        ) : (
                            proposals.map((proposal) => (
                                <article
                                    key={proposal.id}
                                    className="grid grid-cols-[1.2fr_1fr_0.9fr_0.9fr_1.4fr] items-start gap-3 px-4 py-3 text-sm"
                                >
                                    <div className="min-w-0">
                                        <p className="truncate font-medium">
                                            {proposal.title}
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <span className="mt-2 inline-flex rounded-full bg-muted px-2.5 py-1 text-xs">
                                            {label(
                                                statusLabels,
                                                proposal.status,
                                            )}
                                    ...
                                    <div className="grid gap-2">
                                                    ...
                                                    .map((item) => (
                                                        ...
                                                        >
                                                            ...
                                                            {item
                                                                .partnerAllocations
                                                                ?.length
                                                                ? ` (${fa(item.partnerAllocations.length)} سهم‌بندی)`
                                                                : ''}
                                                        </span>
                                                    ))}
                                        ...
                                        <p className="line-clamp-2 text-xs text-muted-foreground">
                                            {proposal.notes ??
                                                proposal.rewardOffer ??
                                                proposal.discountOffer ??
                                                'بدون توضیح تکمیلی'}
                                        </p>
                                        ...
                                        {canMutate ? (
                                            <div className="grid gap-2">
                                                ...
                                                !proposal.activation ? (
                                                    <Form
                                                        action={`/admin/sponsor-proposals/${proposal.id}/activate`}
                                                        method="post"
                                                        options={{
                                                            preserveScroll: true,
                                                        }}
                                                    ...
                                                    <Form
                                                        action={`/admin/sponsor-proposals/${proposal.id}/status`}
                                                        method="post"
                                                        options={{
                                                            preserveScroll: true,
                                                        }}
