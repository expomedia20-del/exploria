            ...
            <main className="space-y-4 p-4" dir="rtl">
                ...
                <section className="space-y-3">
                    {visibleUsers.map((user) => (
                        <details
                            key={user.id}
                            className="group rounded-lg border border-sidebar-border/70 bg-card dark:border-sidebar-border"
                        >
                            ...
                            <div className="border-t border-sidebar-border/70 p-3 dark:border-sidebar-border">
