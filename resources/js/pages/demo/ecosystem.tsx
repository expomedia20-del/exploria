...
const productMilestones = [
    ...
    {
        title: 'تبلیغات فروشگاه و بسته اسپانسر',
        status: 'خارج از کمپین هم پوشش داده شد',
        body: 'تبلیغ فروشگاه از مسیر فروشگاه ثبت می‌شود؛ پیشنهاد برند یا اسپانسر از پنل اسپانسر و مدیریت اسپانسرها پیگیری می‌شود.',
        href: '/admin/sponsors',
        icon: Megaphone,
    },
    {
