        ...
        >
            ...
            <details className="rounded-xl border border-sidebar-border/70 p-3">
                ...
                <div className="mt-3 rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs leading-6 text-amber-950">
                    <p className="font-black">راه دریافت پاداش تقویت‌شده</p>
                    <ol className="mt-2 grid gap-1">
                        <li>
                            ۱. مأموریت‌های اصلی و اسکن‌های حضوری مسیر را کامل
                            کنید؛ امتیاز اصلی از همین مسیر به دست می‌آید.
                        </li>
                        <li>
                            ۲. در صورت تمایل، پیشنهاد امتیازآور همان مرحله را
                            کامل کنید. تبلیغات «ویترین عمومی» امتیاز ندارد.
                        </li>
                        <li>
                            ۳. یک پاداش فعال را از «کیف پاداش من» در فروشگاه،
                            کافه یا رستوران عضو مصرف کنید و کد را به مسئول واحد
                            ارائه دهید.
                        </li>
                        <li>
                            ۴. پس از ثبت مصرف توسط واحد عضو، سطح پاداش به‌صورت
                            خودکار بازبینی می‌شود؛ شرط قدم بعدی در کادر «چگونه
                            پاداش قوی‌تر می‌شود؟» نمایش داده می‌شود.
                        </li>
                    </ol>
                </div>
            </details>
